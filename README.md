...
2. [متغیرها](#متغیرها)
3. [تابع‌ها](#تابعها)
4. [آبجکت‌ها و ساختارهای داده](#آبجکتها)
5. [کلاس‌ها](#classes)
6. [اصول SOLID](#solid)
7. [تست](#testing)
